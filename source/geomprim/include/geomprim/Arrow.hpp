#ifndef OPTOR_SOURCE_GEOMPRIM_INCLUDE_GEOMPRIM_ARROW_HPP
#define OPTOR_SOURCE_GEOMPRIM_INCLUDE_GEOMPRIM_ARROW_HPP
...
class Arrow final: public hui::GeomPrim {

public:

    Arrow(dr4::Window* dr4Window);
...
#endif /* OPTOR_SOURCE_GEOMPRIM_INCLUDE_GEOMPRIM_ARROW_HPP */
